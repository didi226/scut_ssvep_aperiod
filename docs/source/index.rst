...
SSVEP-APERIODIC-Python Homepage
================================

.. LOGO

.. image:: _static/logo.svg
   :alt: SSVEP-APERIODIC-Python
...
.. rst-class:: h4 text-center font-weight-light my-4
   ...
   Open-source Python package for SSVEP calssify, SSVEP indicator measure and extraction of the aperiodic and periodic components from time series signals.
